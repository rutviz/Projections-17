...
<div id="Detailsheader">
	<div id= "text">
	<ul style="height: 50px;margin:0">
		<li onclick="moveit(0)"  id="demo1"><span>Description</span></li>
		<li onclick="moveit(1)" id="demo2" ><span>Rounds</span></li>	
		<li onclick="moveit(2)" id="demo3"><span>Rules</span></li>
		<li onclick="moveit(3)" id="demo4"><span>Contact<span></li>
	</ul>
	</div>
	</div>
	...
	<div class="swiper-slide" href="#one!" style="background: #44A08D; /* fallback for old browsers */
...
<p style="font-size:150%;">•	Selection would be done on the basis of accurate product and the first one to complete it.</p>  
	...
	<div class="swiper-slide" style="background: #5A3F37; /* fallback for old browsers */
...
<div class="swiper-slide" style="padding:0;background: #F3904F; /* fallback for old browsers */
